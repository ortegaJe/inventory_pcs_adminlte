    ...
    <div class="col-sm-6" style="margin-left: 410px">
      <div class="card card-secondary">
        <div class="card-header">
          <h3 class="card-title" style="font-weight: 700; font-size:20px">Informacion detallada | {{ $machine->serial }}
          </h3>
        </div>
        <div class="card-body">
          <form action="" method="POST">
              ...
              <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                  ...
                  <input value="{{ $machine->model }}" name="model" style="text-transform:uppercase;"
                    onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" disabled>
                </div>
              </div>
            ...
            <div class="input-group">
              ...
              <textarea class="form-control" maxlength="200" id="" name="comment" value="{{ $machine->comment }}"
                disabled></textarea>
            </div>
          </form>
        </div>
