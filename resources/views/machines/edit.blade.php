  ...
  <div class="col-sm-6" style="margin-left: 410px">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title" style="font-weight: 700; font-size:20px">Actualizar Equipo | {{ $machine->serial }}</h3>
        </div>
      <div class="card-body">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input value="{{ $machine->manufacturer }}" name="manufact" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" id="name-input" placeholder="HP">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input value="{{ $machine->model }}" name="model" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" placeholder="">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input value="{{ $machine->serial }}" name="serial" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" placeholder="S/N" >
                    </div>
                  </div>
                </div>
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-8 mb-4">
                    ...
                    <div class="input-group">
                      ...
                      <input name="cpu" value="{{ $machine->cpu }}" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control"  placeholder="">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="col-sm-4 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" maxlength="15" class="form-control" name="ip" value="{{ $machine->ip_range }}" placeholder="000.000.000.000" >
                    </div>
                  </div>
                  ...
                  <div class="col-sm-4 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input name="mac" value="{{ $machine->mac_address }}" style="text-transform:uppercase;" maxlength="17" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" placeholder="00-00-00-00-00-00" >
                    </div>
                  </div>
                  ...
                  <div class="col-sm-4 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="anydesk" value="{{ $machine->anydesk }}" placeholder="000 000 000">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input name="location" value="{{ $machine->location }}" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" placeholder="" >
                    </div>
                  </div>
