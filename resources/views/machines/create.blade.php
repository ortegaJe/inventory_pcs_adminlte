                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" id="name-input" name="manufact" placeholder="HP">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" name="model" placeholder="">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" name="serial" placeholder="S/N" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-8 mb-4">
                    ...
                    <div class="input-group">
                      ...
                      <input style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" name="cpu" placeholder="">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="col-sm-4 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" maxlength="15" class="form-control" name="ip" placeholder="000.000.000.000" required>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-4 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input style="text-transform:uppercase;" maxlength="17" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" name="mac" placeholder="00-00-00-00-00-00" required>
                    </div>
                  </div>
                ...
                <div class="form-row">
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" class="form-control" name="location" placeholder="" required>
                    </div>
                  </div>
