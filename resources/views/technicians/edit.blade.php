...
@section('content')
<div class="col-sm-20 mx-auto m-2">
  <div class="card card-success">
    ...
    <div class="card-body">
      <form action="{{ route('technicians.update', $user->id ) }}" method="POST" enctype="multipart/form-data">
        @method('PATCH')
        @csrf

        @if($errors->any())
        <div class="alert alert-danger alert-dismissible fade show" style="d-none">
        ...
        <div class="form-row">
          <div class="col-md-4 mb-3">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" name="cc" pattern="[0-9]+" maxlength="10" value="{{ $user->cc }}">
            </div>
          </div>
          <div class="col-md-4 mb-3">
        ...
        <div class="form-row">
          <div class="col-md-3 mb-3">
            ...
            <div class="input-group">
              ...
              <input type="tel" class="form-control" name="phone" value="{{ $user->phone }}" placeholder="300-0000-000"
        ...
        <div class="form-row">
          <div class="col-sm-6 mb-3">
            ...
            <div class="input-group">
              ...
              <select class="custom-select" name="campus">
                ...
                <option value="{{ $campu->id }}" {{ $campu->id == $user->campus_id ? 'selected' : '' }}>
          ...
          <div class="col-sm-6 mb-3">
            ...
            <div class="input-group">
              ...
              <select class="custom-select" name="work-function" value="{{ $user->work_function }}">
        ...
        <div class="form-group">
          ...
          @if($user->image != "")
          <img class="img-circle elevation-2 mt-2" src="{{ asset('upload/'.$user->image) }}" alt="{{ $user->image }}"
