...
(10) NOT NULL,
  `campus` varchar
(56) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pos_job` varchar
(56) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar
(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
`nick_name`,
`password
`, `phone`, `campus`, `pos_job`, `email`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`) VALUES
...
`nick_name`,
`password
`, `phone`, `campus_id`, `work_function`, `email`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`) VALUES
(NULL, '1143434718', 'Jefferson Javier', 'Ortega Pacheco', 'Jortega', '$2y$10$MoXvdKIgd3/nHnGbOqYQueW9R3e8An8T7CaB.vPr6uhNRoaBIR91y', '2002777694', '1', 'Tech Support', 'admin@inventor.co', NULL, NULL, NULL, NULL);
...
ALTER TABLE `users`
  MODIFY `id` bigint
(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
