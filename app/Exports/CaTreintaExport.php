...
class CaTreintaExport implements 
    FromCollection,
    Responsable,
    //ShouldAutoSize,
    WithColumnWidths,
    ...
    WithCustomStartCell
{
    ...
    private $fileName = "inventor_machines_c30.xlsx";
    /**
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->getCell('B2')->setValue("INVENTARIO DE EQUIPOS REGISTRADOS | SEDE VIVA 1A CALLE 30");
